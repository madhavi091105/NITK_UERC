...
class TinyVITStudentModel(nn.Module):
    """
    TinyViT-11M backbone with a 512-dim projection head.
    ...
    def __init__(self, embedding_dim=512):
        super().__init__()
        self.backbone = timm.create_model('tiny_vit_11m_224', pretrained=False, num_classes=0)
        self.projection = nn.Sequential(
            nn.Linear(448, embedding_dim),
